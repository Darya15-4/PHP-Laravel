...
<article class="article-full">
    ...
    <div class="article-full__actions">
        ...
        <a href="/?route=article/<?= $article->getId(); ?>/delete" class="article-full__link" onclick="return confirm('Удалить статью?');">Удалить</a>
    </div>
</article>
...
<section class="add-comment">
    ...
    <form class="add-comment__form" action="/?route=article/<?= $article->getId(); ?>/comments" method="post">
